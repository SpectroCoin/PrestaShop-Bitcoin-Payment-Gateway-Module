      ...
      <div class="flex-col-2 flex-col">
        ...
        <div class="introduction">
          ...
          <ul>
            ...
            <li>6. The <b>Private Key</b> can be obtained by switching on the Public key radio button (Private key will not
              be visible in the settings window, and it will have to be regenerated in settings). Copy or download the newly
