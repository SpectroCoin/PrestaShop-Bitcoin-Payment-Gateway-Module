 ...
 *
 * Standalone by design: this plugin ships no PHPUnit setup, and a PrestaShop
...
$callbackSource = file_get_contents(__DIR__ . '/../controllers/front/callback.php');

$t = new TestRunner();
echo "SpectroCoin PrestaShop — order-status coverage\n\n";
